...
# Optional readback APIs differ across Civ VI builds and Lua contexts. Protect
# only metadata reads with this helper, never state-changing requests or rules
# whose failure must reject an action rather than silently permit it.
_LUA_SAFE_READ = """
