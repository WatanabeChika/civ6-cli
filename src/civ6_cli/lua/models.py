...
class TechCivicStatus:
    ...
    current_research_progress: float | None = None
    current_research_cost: float | None = None
    current_civic_progress: float | None = None
    current_civic_cost: float | None = None
...
@dataclass
class TradeOption:
    """A native selectable instance or agreement parameter, not an inventory guess."""
    kind: str
    side: str
    name: str
    term: str
...
class DealOptions:
    ...
    native_options: list[TradeOption] = field(default_factory=list)
...
class GreatPersonInfo:
    ...
    can_recruit: bool | None = False  # None = optional native API unavailable
...
class TradeDestination:
    ...
    one_way_distance: int | None = None
